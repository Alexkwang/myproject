(function() {
  ...
  if (env === "GDEV") {
    config.mongodbAddress ="mongodb://localhost:27017/test2";
    ...
    config.mongodbAddress = "mongodb://192.168.1.110/test2,192.168.1.111/test2?readPreference=primaryPreferred";
